...
let currentFighter = turn ? enemy : player
  ...
  function happenings() {
		...
		{
			let message = `${turn} ? ${player.name}'s turrrrrn : ${enemy.name}'s turn`;
			return message;
		}
    ...
    return ( <div>
      <div class='battle'>
           ...
           <div class='enemyPokemon'>
            ...
            <img style={{ imageRendering: "pixelated" }} src={enemy.sprites.front_default} alt={'pokemon'} />
            </div>
            ...
            <img style={{ imageRendering: "pixelated" }} src={player.sprites.front_default} alt={'pokemon'} />
            </div>
         ...
         <h2>{happenings()}</h2>
      <div>
        <button id='attackButton' onClick={handleAttackClick}>Attack!</button>
